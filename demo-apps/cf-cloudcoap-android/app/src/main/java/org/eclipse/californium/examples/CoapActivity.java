...
import static org.eclipse.californium.examples.PreferenceIDs.COAP_RIDS;
...
public class CoapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager(), 0 < supportJobs);
        pageListener = new MyOnPageChangeListener(0 < supportJobs);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_reset_id) {
            ...
            preferences.edit().putString(COAP_UNIQUE_ID, uniqueID).putString(COAP_RIDS, "").apply();
            CoapContext.getInstance().resetSessionCache();
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public SectionsPagerAdapter(FragmentManager fm, boolean statistic) {
            super(fm);
    ...
    public class MyOnPageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        public MyOnPageChangeListener(boolean statistic) {
            this.statistic = statistic;
        }

        @Override
        public void onPageSelected(int position) {
            if (position != (statistic ? 2 : 1)) {
                adjustDtlsMode();
            }
        }
    }
