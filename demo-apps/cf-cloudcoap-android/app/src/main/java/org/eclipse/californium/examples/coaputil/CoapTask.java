        ...
        try {
            ...
            if (resource.isEmpty()) {
                ...
                switch (mode) {
                    ...
                    case STATISTIC:
                        ...
                        rid = RID_PREFIX + System.currentTimeMillis();
            ...
            request.addMessageObserver(new MessageObserverAdapter() {
                ...
                public void onRetransmission() {
                    ...
                    publishProgress(progress);
                    if (dtls && startConnect == null && progress.coapRetries > 2) {
    ...
    public static String formatDuration(long timeMillis) {
        if (timeMillis < 10000) {
            ...
            if (millis == 0) {
                ...
                return String.format("%d,%3d [s]", (timeMillis / 1000), millis);
            }
        } else {
            ...
            if (seconds == 0) {
                ...
                return String.format("%d:%2d [min:s]", (timeS / 60), seconds);
            }
        }
    }
}
